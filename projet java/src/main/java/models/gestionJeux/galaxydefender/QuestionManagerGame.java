...
public class QuestionManagerGame {
    public static class Question {
        ...
        public boolean checkAnswer(String userAnswer) { return answer.equalsIgnoreCase(userAnswer.trim()); }
    }
    ...
    public Question getRandomQuestion() { return QUESTIONS.get(random.nextInt(QUESTIONS.size())); }
}
