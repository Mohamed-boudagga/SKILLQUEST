...
public class Games {
    ...
    public Games(int id, String typeJeux, String difficulte, int timeLimit, int scoreMax, String description) {
        this.id = id; this.typeJeux = typeJeux; this.difficulte = difficulte;
        this.timeLimit = timeLimit; this.scoreMax = scoreMax; this.description = description;
    }

    public Games(String typeJeux, String difficulte, int timeLimit, int scoreMax, String description) {
        this.typeJeux = typeJeux; this.difficulte = difficulte;
        this.timeLimit = timeLimit; this.scoreMax = scoreMax; this.description = description;
    }

    public int getId() { return id; }
    public void setId(int id) { this.id = id; }
    public String getTypeJeux() { return typeJeux; }
    public void setTypeJeux(String typeJeux) { this.typeJeux = typeJeux; }
    ...
    public String toString() {
        return "Games{id=" + id + ", typeJeux='" + typeJeux + "', difficulte='" + difficulte + "'}";
    }
}
